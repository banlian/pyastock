                ...
                l.abort(), l = $.ajax({
                    ...
                    success: function(t) {
                        ...
                        for(var idx = 0; idx < stockList.length; idx++){
                            //var postFix = stockList[i].f13 == 0 ? ".SZ" : ".SH"
                            //var key = stockList[i].f12 + postFix; // 这个是使用股票代码做key
                            var key = stockList[idx].f14.replace(/\s/g,"")  //这个是使用股票名字做key
    ...
    58: function(e, t, a) {
        ...
        window.zntyInitCanvas = function(e, t, a, b, h, p, m, y, ignoreAuth) {
            ...
            var v = (Math.max(document.documentElement.clientWidth, window.innerWidth || 0), c.w = b),
                // g = c.h = ~~(v / 1.8);
                g = Math.max(document.documentElement.clientHeight+10, window.innerHeight+10 || 0);
            g = g - 10;
