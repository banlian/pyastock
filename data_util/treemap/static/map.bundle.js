!function (e) {
    ...
    13: function (e, t) {
        var a = React.addons.classSet
            ...
            render: function () {
                ...
                return void 0 === c && (c = this.props.options[0]),
    ...
    19: function (e, t) {
        var a = function () {
            var e = new Date;
            return e.setTime(e.getTime() + 60 * (e.getTimezoneOffset() + -240) * 1e3),
                e
        }
            , c = function () {
            ...
            var e = a()
                ...
                , c = e.getMinutes()
                , n = !1;
            return FinvizSettings.hasUserPremium && 0 != t && 6 != t && 9 == e.getHours() && c < 30 && (n = !0),
                n
        };
        e.exports = {
            getTimeString: c,
        ...
        var c = a(0)
            ...
            render: function () {
                ...
                if (!this.state.colorScale)
                    return null;
                for (var t = "cssbody=[tooltip_bdy] cssheader=[tooltip_hdr] header=[" + this.props.scale.name + "] body=[<table width=300><tr><td class='tooltip_tab'>" + this.props.scale.tooltip + "</td></tr></table>] offsety=[-70] delay=[500]", a = this.state.colorScale, d = [c.scaleMinMax[this.props.scale.id][0]], i = c.scaleMinMax[this.props.scale.id][1] - d[0], r = i / 6, o = 1; o < 7; o++)
        ...
        var n = function () {
            ...
            function e(t, n, d, r, o, s, f) {
                ...
                if (c(this, e),
                    ...
                    this.h = d,
                    this.scaleId = o,
                    this.countIndustryPerf = s,
                    this.countSectorPerf = f,
                    this.nodes = [],
                    this.sectors = [],
                    this.industries = [],
                    r) {
    ...
    5: function (e, t, a) {
        ...
        c.prototype.register = function (e) {
            var t = "ID_" + d++;
            return this.$Dispatcher_callbacks[t] = e,
                t
        }
            ,
            ...
            c.prototype.waitFor = function (e) {
                ...
                for (var t = 0; t < e.length; t++) {
                    var a = e[t];
                    this.$Dispatcher_isPending[a] ? n(this.$Dispatcher_isHandled[a], "Dispatcher.waitFor(...): Circular dependency detected while waiting for `%s`.", a) : (n(this.$Dispatcher_callbacks[a], "Dispatcher.waitFor(...): `%s` does not map to a registered callback.", a),
    ...
    58: function (e, t, a) {
        ...
        window.zntyInitCanvas = function (e, t, a, b, h, p, m, y, ignoreAuth) {
            ...
            l.isWidget() || (React.render(React.createElement(d, {
                ...
                l.isWidget()) || (React.render(React.createElement(r, null), document.getElementById("hover-wrapper")),
    ...
    9: function (e, t, a) {
        ...
        var i, r, o, s, f, l = function () {
            ...
            }(), u = a(45), h = a(32).ActionTypes, p = a(95), m = a(47), y = a(19), v = y.getTimeString, g = !1, A = [],
            S = 1, x = "", E = {
                shown: !1,
                failed: !1,
                completed: !1,
        ...
        var c = a(9)
            ...
            render: function () {
                ...
                return React.createElement("div", {
                    ...
                    className: "ticker",
                    width: 98
                }, stockCode), React.createElement("td", {
                    className: "ticker",
                    width: 98
                    ...
                    colSpan: "4"
                }, null)), React.createElement("tr", null, React.createElement("td", {
                    colSpan: "4"
                }, React.createElement("img", {
                    className: "smallLine",
                    width:350,
                    src: "http://image.sinajs.cn/newchart/daily/n/" + prefix + stockCode + ".gif"
                    ...
                    }, listStockCode), React.createElement("td", {
                        className: "smallticker"
                    }, t.name), React.createElement("td", null, React.createElement("img", {
                        className: "smallLine",
    ...
    93: function (e, t, a) {
        var c = a(20)
            ...
            _onMouseLeave: function (e) {// c.setHoveredNode(vod 0)
            },
